...
const Profile = () => {
    return (
        <section className='py-[10px] pt-[90px] bg-[#1f1f1f]'>
            <div className="container px-[10px] lg:px-[0px] mx-auto">
                ...
                <div className="Download flex gap-1 justify-end mx-auto my-[20px] lg:w-[90%]">
                    <a href="tel:01813904257" className=' hover:bg-[#fff] hover:text-[red] w-[40px] h-[40px] flex justify-center items-center font-alsiam text-[#fff] text-[20px] rounded-[10px] border-[2px] border-[red]' ><MdCall/></a>
                    <a href="https://wa.me/message/3RGTSTCX3MO2G1" className=' hover:bg-[#fff] hover:text-[red] w-[40px] h-[40px] flex justify-center items-center font-alsiam text-[#fff] text-[20px] rounded-[10px] border-[2px] border-[red]' ><FaWhatsapp/></a>
